---
description: How to upload a file on a REST API?
complexity: 2
---

# File upload on an API
...
And expose a second resource related to the previous one for the file upload, like described earlier: 
```shell
...
curl \
  ...
  --form metadata="{\"title\":\"Mes images\"}" \
  --form file1=<file1> \
  --form file2=<file2> \
